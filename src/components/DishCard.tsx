    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow" onClick={openModal}>
      ...
      <div className="p-4">
        <div className="flex items-center justify-between mb-2">
          <h3 className="text-lg font-semibold text-gray-800 cursor-pointer" onClick={(e) => { e.stopPropagation(); openModal() }}>{dish.name}</h3>
        ...
        <div className="mb-4">
          <p className="text-sm text-gray-600 mb-2">主要食材：</p>
        ...
        <button
          ...
          className={`w-full py-3 sm:py-2 px-4 rounded-lg font-medium transition-colors ${
            isSelected
